...
- 提供商保护：为 Antigravity、xAI、Codex、Gemini CLI、Gemini、Gemini Interactions、Vertex AI、AI Studio、Claude 和 Kimi 分别配置开关、HTTP 状态码、连续确认门槛、确认窗口、429 配额证据、自动解除和兜底禁用时长。
- 运行状态：查看当前由请求保护策略禁用的账号和最近事件，并手动解除单个账号。
